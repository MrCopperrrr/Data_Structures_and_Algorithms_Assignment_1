 ...
 * build code : 
g++ -o main -Iinclude -Isrc -std=c++17 main.cpp src/util/Point.cpp test/unit_test/arrayList/unit_test.cpp test/unit_test/linkedList/unit_test.cpp test/random_test/random_test.cpp
 * run code
